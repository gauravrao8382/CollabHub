...
import { 
  ...
  CheckCircle, XCircle, Clock, Eye, Plus 
} from 'lucide-react';
      ...
      >
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center text-white font-bold shadow-sm">
        ...
        {/* Expandable Section - Applicants & Actions */}
        <AnimatePresence>
          {isExpanded && (
            <motion.div
                      ...
                      {proj.applicants?.slice(0, 3).map((applicant, idx) => (
                        <div key={idx} className="flex items-center justify-between p-2 bg-slate-50 rounded-lg">
                          <div className="flex items-center gap-2">
                            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-fuchsia-400 to-pink-400 flex items-center justify-center text-white text-[10px] font-medium">
                          ...
                          <div className="flex gap-1">
                            ...
                            <button className="p-1.5 text-red-500 hover:bg-red-50 rounded transition-colors" title="Reject">
                              <XCircle size={14} />
                            </button>
                          </div>
                        </div>
