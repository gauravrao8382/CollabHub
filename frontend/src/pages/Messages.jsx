  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-950 via-stone-900 to-amber-950/30 text-stone-100 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-stone-400">Connect with your project teams</p>
            </div>
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 relative z-10">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-amber-500/10 via-orange-500/10 to-rose-500/10 rounded-2xl blur-xl opacity-0 focus-within:opacity-100 transition duration-300 pointer-events-none" />
          <div className="relative bg-stone-800/40 border border-stone-700/50 rounded-2xl flex items-center p-2 backdrop-blur-xl">
            <Search className="ml-3 text-stone-500" size={20} />
            <input
              type="text"
              ...
              className="w-full pl-3 pr-4 py-3 bg-transparent border-none focus:outline-none 
                       text-stone-100 placeholder-stone-500 focus:ring-0"
            />
            {searchTerm && (
              <button 
        ...
        >
          ...
          <div className="p-5 border-b border-stone-700/50 flex items-center justify-between">
            <h2 className="font-bold text-stone-100 flex items-center gap-2.5">
            ...
            <AnimatePresence mode="popLayout">
              {myProjects.length > 0 ? (
                ...
                >
                  {myProjects.map((project) => (
                    <motion.button
                      ...
                      className="w-full p-5 flex items-center gap-4 hover:bg-stone-700/30 
                               transition text-left group border-b border-stone-700/30 last:border-0"
                    >
                      ...
                      <div className="relative flex-shrink-0">
                        ...
                        <span className={`absolute -bottom-1 -right-1 w-5.5 h-5.5 rounded-full 
                                       border-2 border-stone-900 flex items-center justify-center ${
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-stone-100 truncate group-hover:text-amber-300 transition-colors">
                          {project.title}
                        </h3>
                        <p className="text-xs text-stone-400 mt-1 line-clamp-1">{project.description}</p>
                      ...
                      <div className="flex items-center gap-2 flex-shrink-0">
                        {project.unreadCount > 0 && (
                          <span className="w-5 h-5 rounded-full bg-amber-500 text-white 
                                         text-[10px] font-bold flex items-center justify-center">
                            {project.unreadCount > 9 ? '9+' : project.unreadCount}
                          </span>
                        )}
                        <ChevronRight size={18} className="text-stone-500 group-hover:text-amber-400 
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold text-stone-100 mb-2">No projects yet</h3>
                  ...
                  <motion.button
                    ...
                    className="px-6 py-3 rounded-xl bg-gradient-to-r from-amber-600 via-orange-600 to-rose-600 
                             ...
                             transition-all shadow-lg shadow-amber-500/30 hover:shadow-amber-500/50 
